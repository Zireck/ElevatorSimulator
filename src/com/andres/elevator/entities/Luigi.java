...
public class Luigi extends Character {
	...
	protected void loadSprites() {
		try {
			...
			spritesWalkingTiny[2] = mSpriteSheet.getSubimage(128, 80, 16, 16);
			spritesIdleRegular[0] = mSpriteSheet.getSubimage(80, 48, 16, 32);
			spritesWalkingRegular[0] = mSpriteSheet.getSubimage(96, 48, 16, 32);
			spritesWalkingRegular[1] = mSpriteSheet.getSubimage(112, 48, 16, 32);
			spritesWalkingRegular[2] = mSpriteSheet.getSubimage(128, 48, 16, 32);
			...
			spritesDeadTiny[0] = mSpriteSheet.getSubimage(176, 80, 16, 16);
